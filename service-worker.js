...
// Bump cache version because we fixed multibyte filename handling for uploads
// and adjusted error reporting in main.js. Updating the cache name forces
// clients to fetch the latest scripts.
const CACHE_NAME = 'location-chat-cache-v17';
